...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If there was a temporary booking in progress, check it
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="bg-white border border-cream-200/50 p-8 rounded-xl luxury-shadow max-w-md w-full space-y-6">
        ...
        <div className="text-center">
          <h2 className="font-playfair text-3xl font-bold text-slate-800">Welcome Back</h2>
          <p className="text-slate-500 text-xs mt-1">Please enter your credentials to log in to KR Rental Outfits.</p>
        ...
        <div className="border-t border-cream-100 pt-4 text-center text-xs text-slate-500">
          <p>Don't have an account? <Link to="/register" className="text-maroon-500 hover:underline font-bold">Register Here</Link></p>
        </div>

        {/* Demo Credentials Alert */}
        <div className="bg-cream-100/50 border border-cream-200/60 p-4 rounded-lg text-[11px] text-slate-500 leading-relaxed space-y-1">
          <p className="font-bold text-slate-700">Demo Accounts:</p>
          <p><strong>Admin:</strong> admin@krrentaloutfits.com / password: <code>admin123</code></p>
          <p><strong>Customer:</strong> aisha@example.com / password: <code>user123</code></p>
        </div>
